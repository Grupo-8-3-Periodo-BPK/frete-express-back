...
class FreightControllerTest {
    ...
    @Test
    void getById_WithNonExistingFreight_ShouldReturnNull() throws Exception {
    ...
    void delete_WithPendingContracts_ShouldDeleteFreightAndContracts() throws Exception {
        ...
        when(trackingRepository.findByContract(pendingContract)).thenReturn(Arrays.asList(tracking));
        ...
        verify(trackingRepository).deleteAll(Arrays.asList(tracking));
